...
The `DemoMonkey` maintainers take all security issues in the project
seriously. Thank you for improving the security of `DemoMonkey`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`DemoMonkey` leverages GitHub's private vulnerability reporting.
...
out via [email](mailto:severin.neumann@altmuehlnet.de).
