...
const stringFunctions = {
  ...
  headerCase: (str) => changeCase.trainCase(str),
  noCase: (str) => changeCase.noCase(str),
  paramCase: (str) => changeCase.kebabCase(str),
  // Aliases for backwards compatibility
  kebabCase: (str) => changeCase.kebabCase(str),
  trainCase: (str) => changeCase.trainCase(str),
