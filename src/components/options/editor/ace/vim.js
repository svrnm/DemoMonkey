...
function vim(writeHandler) {
  return ace.define(
    ...
    (acequire, exports, module) => {
      return vimHandler(acequire, exports, module, writeHandler)
    }
  )
}

function vimHandler(acequire, exports, module, writeHandler) {
  'use strict'
  ...
  CodeMirror.keyMap = {}
  CodeMirror.addClass = CodeMirror.rmClass = CodeMirror.e_stop = function () {}
  ...
  ;(function () {
    ...
    this.replaceRange = function (text, s, e) {
      if (!e) e = s
      return this.ace.session.replace(
        new Range(s.line, s.ch, e.line, e.ch),
        text
      )
    }
...
.ace_dialog input {\
  ...
  function recordLastCharacterSearch(increment, args) {
    ...
    vimGlobalState.lastChararacterSearch.selectedCharacter =
  ...
  Vim.defineEx('write', 'w', function () {
    if (typeof writeHandler === 'function') {
      console.log(':write is implemented')
      return writeHandler()
    }
