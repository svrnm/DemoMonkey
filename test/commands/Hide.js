...
describe('Hide', function () {
  describe('#apply', function () {
    it('hides a text node', function () {
      ...
      expect(new Hide('test', 1, '', '', '', location).apply(node, 'value')).to.be.an.instanceof(
        UndoElement
      )
      assert.equal(node.parentElement.style.display, 'none')
      expect(new Hide('test', 2, '', '', '', location).apply(node, 'value')).to.be.an.instanceof(
        UndoElement
      )
    ...
    it('hides a text node if filter applies', function () {
      ...
      expect(new Hide('test', 1, 'one', '', '', location).apply(node, 'value')).to.be.an.instanceof(
        UndoElement
      )
      assert.equal(node.parentElement.style.display, 'none')
      ...
      expect(new Hide('test', 1, '', 'old', '', location).apply(node, 'value')).to.be.an.instanceof(
        UndoElement
      )
      assert.equal(node.parentElement.style.display, 'none')
      ...
      expect(new Hide('test', 1, '', '', 'ash', location).apply(node, 'value')).to.be.an.instanceof(
        UndoElement
      )
      assert.equal(node.parentElement.style.display, 'none')
